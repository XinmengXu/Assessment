def asr_supported_template(target_word, target_phoneme, speaking_target):
    if target_phoneme:
        return {
            ...
            "diagnosis": "This word may need attention in your next attempt.",
            "criterion_link": "This task focuses on pronunciation clarity for the /%s/ sound in '%s'." % (target_phoneme, target_word),
            "explanation": "This is a weak ASR-supported cue, not an exact pronunciation diagnosis.",
            ...
            "practice_suggestion": "Practise /%s/ in '%s', then read the phrase, then read the full sentence again." % (target_phoneme, target_word),
...
def model_supported_template(target_word, target_phoneme, score=None, confidence=None, speaking_target="pronunciation_clarity"):
    return {
        ...
        "diagnosis": "The pronunciation assessment model detected a possible pronunciation issue in this word.",
        "criterion_link": "This relates to pronunciation clarity and listener recognition of the focus word.",
        "explanation": "The model evidence suggests that the target sound in this word may need attention.",
...
def human_validated_template(target_word, target_phoneme, observed_phoneme, speaking_target="pronunciation_clarity"):
    return {
        ...
        "diagnosis": "The reviewer confirmed that this word needs pronunciation attention.",
        "criterion_link": "This affects pronunciation clarity because the target sound helps listeners identify the intended word.",
        "explanation": "The reviewer checked this item and confirmed that targeted practice is appropriate.",
...
def generic_no_phoneme_template(target_word, speaking_target):
    return {
        ...
        "sound_focus_label": "",
        "evidence_level_label": "ASR-supported cue",
        "diagnosis": "This word may need attention in your next attempt." if target_word else "A focus word may need attention in your next attempt.",
        "criterion_link": "Sound-specific feedback is unavailable for this task because no focus phoneme was defined.",
        "explanation": "AI cue based on speech recognition. Use it as practice support.",
        "action_guidance": "Practise the focus word, then read the phrase and full sentence again.",
        "practice_suggestion": "Listen to the model audio, repeat '%s', then re-record the sentence." % target_word if target_word else "Listen to the model audio, repeat the focus word, then re-record the sentence.",
